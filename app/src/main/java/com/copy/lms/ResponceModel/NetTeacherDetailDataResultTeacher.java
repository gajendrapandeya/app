...
public class NetTeacherDetailDataResultTeacher {
    ...
    private ArrayList<NetTeacherDetailDataResultTeacherCourses> courses;
    ...
    private String dob;
    private NetTeacherDetailDataResultTeacherBundles[] bundles;
    ...
    public ArrayList<NetTeacherDetailDataResultTeacherCourses> getCourses() {
        return this.courses;
    }

    public void setCourses(ArrayList<NetTeacherDetailDataResultTeacherCourses> courses) {
    ...
    public NetTeacherDetailDataResultTeacherBundles[] getBundles() {
        return this.bundles;
    }

    public void setBundles(NetTeacherDetailDataResultTeacherBundles[] bundles) {
