...
public class NetBundleDetailDataResultCourses {
    ...
    private NetBundleDetailDataResultCoursesPivot pivot;
    private int id;
    private int free;
    private int popular;
    private String slug;
    ...
    public NetBundleDetailDataResultCoursesPivot getPivot() {
        return this.pivot;
    }

    public void setPivot(NetBundleDetailDataResultCoursesPivot pivot) {
        this.pivot = pivot;
    }
