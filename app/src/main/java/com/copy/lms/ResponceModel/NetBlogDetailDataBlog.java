...
public class NetBlogDetailDataBlog {
    private String image;
    private String blog_author;
    private String blog_category;
    private String meta_title;
    private NetBlogDetailDataBlogAuthor author;
    ...
    private int user_id;
    private int id;
    private NetBlogDetailDataBlogCategory category;
    private String slug;
    private int views;
    ...
    public NetBlogDetailDataBlogAuthor getAuthor() {
        return this.author;
    }

    public void setAuthor(NetBlogDetailDataBlogAuthor author) {
        this.author = author;
    }
    ...
    public NetBlogDetailDataBlogCategory getCategory() {
        return this.category;
    }

    public void setCategory(NetBlogDetailDataBlogCategory category) {
