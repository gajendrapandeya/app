...
public class NetTeacherDataResultData {
    ...
    private NetTeacherDataResultDataTeacher_profile teacher_profile;
    ...
    public NetTeacherDataResultDataTeacher_profile getTeacher_profile() {
        return this.teacher_profile;
    }

    public void setTeacher_profile(NetTeacherDataResultDataTeacher_profile teacher_profile) {
