...
public class NetSingleCourseDataResultCourseTeachers {
    ...
    private NetSingleCourseDataResultCourseTeachersPivot pivot;
    private int id;
    ...
    public NetSingleCourseDataResultCourseTeachersPivot getPivot() {
        return this.pivot;
    }

    public void setPivot(NetSingleCourseDataResultCourseTeachersPivot pivot) {
        this.pivot = pivot;
    }
