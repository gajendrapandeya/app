...
public class NetCourseSearchResultDataTeachers {
    ...
    private NetCourseSearchResultDataTeachersPivot pivot;
    private int id;
    ...
    public NetCourseSearchResultDataTeachersPivot getPivot() {
        return this.pivot;
    }

    public void setPivot(NetCourseSearchResultDataTeachersPivot pivot) {
        this.pivot = pivot;
    }
