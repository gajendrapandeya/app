...
import com.copy.lms.util.CheckForSDCard;
...
public class DownloadTask {
    ...
    private class DownloadingTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(context,R.style.Theme_MyDialog);
                ...
                if (outputFile != null) {
                    ...
                    alertDialogBuilder.setNegativeButton("Open report", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            File pdfFile = Environment.getExternalStoragePublicDirectory(
                                    Environment.DIRECTORY_PICTURES);
                            File file = new File(pdfFile, "DemoPicture.pdf");
//                            File pdfFile = new File(Environment.getExternalStorageDirectory() + "/Lms/" + downloadFileName);  // -> filename = maven.pdf
...
//                    Toast.makeText(context, "Document Downloaded Successfully", Toast.LENGTH_SHORT).show();
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                progressDialog.hide();
                Toast.makeText(context, context.getString(R.string.somthingwrong), Toast.LENGTH_SHORT).show();
