...
import com.copy.lms.databinding.RowWishItemBinding;
...
public class WishListAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<WishModel> arrayList;
    ...
    public WishListAdapter(Context context, ArrayList<WishModel> arrayList, OnRecyclerItemClick onItemClick) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.row_wish_item, parent, false));
    }
...
//        h.binding.setWishModel(arrayList.get(position));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private RowWishItemBinding binding;
