...
public class CourseListAdapter extends RecyclerView.Adapter {
    ...
    public CourseListAdapter(Context context, ArrayList<CourseModel> arrayList, OnRecyclerItemClick onItemClick) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.row_course_item, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder vh, int position) {
        ...
        h.binding.setCourseModel(arrayList.get(position));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private RowCourseItemBinding binding;
