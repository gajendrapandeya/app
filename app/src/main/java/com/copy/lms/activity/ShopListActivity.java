...
import com.copy.lms.adapter.ShopListAdapter;
import com.copy.lms.basecomponent.BaseActivity;
import com.copy.lms.callBack.OnRecyclerItemClick;
import com.copy.lms.databinding.ActivityShoplistBinding;
import com.copy.lms.model.ShopListModel;
import com.copy.lms.model.ShopModel;
...
public class ShopListActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void setModelAndBinding() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_shoplist);
        model = new ShopListModel();
        model.setArrayList(new ArrayList<ShopModel>());
        binding.setShopListModel(model);
    ...
    public void setToolBar() {
        if (binding.included.toolbar != null) {
            binding.included.txtTitle.setText(getString(R.string.shop));
    ...
    private void initRecycler() {
        ...
        binding.recyclerView.setAdapter(new ShopListAdapter(ShopListActivity.this,
