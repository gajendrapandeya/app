...
public class TestimonialListModel extends BaseObservable {
    ...
    public ArrayList<TestimonialModel> getArrayList() {
        return arrayList;
    }

    public void setArrayList(ArrayList<TestimonialModel> arrayList) {
