...
public class BundleDetailListModel extends BaseObservable {
    ...
    public ArrayList<BundleDetailModel> getArrayList() {
        return arrayList;
    }

    public void setArrayList(ArrayList<BundleDetailModel> arrayList) {
