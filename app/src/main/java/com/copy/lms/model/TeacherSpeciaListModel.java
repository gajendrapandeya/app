...
public class TeacherSpeciaListModel extends BaseObservable {
    ...
    public ArrayList<TeacherSpecialModel> getArrayList() {
        return arrayList;
    }

    public void setArrayList(ArrayList<TeacherSpecialModel> arrayList) {
