...
public class BundleDetailModel extends BaseObservable implements Parcelable {
    ...
    protected BundleDetailModel(Parcel in) {
        trending = in.readInt();
        image = in.readString();
        featured = in.readInt();
    ...
    public static final Creator<BundleDetailModel> CREATOR = new Creator<BundleDetailModel>() {
        @Override
        public BundleDetailModel createFromParcel(Parcel in) {
            return new BundleDetailModel(in);
        }

        @Override
        public BundleDetailModel[] newArray(int size) {
            return new BundleDetailModel[size];
        }
    };
