...
public class CourseDetailListModel extends BaseObservable {
    ...
    public ArrayList<CourseDetailModel> getArrayList() {
        return arrayList;
    }

    public void setArrayList(ArrayList<CourseDetailModel> arrayList) {
