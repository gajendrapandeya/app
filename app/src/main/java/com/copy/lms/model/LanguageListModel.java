...
public class LanguageListModel extends BaseObservable {
    ...
    public ArrayList<LanguageModel> getArrayList() {
        return arrayList;
    }

    public void setArrayList(ArrayList<LanguageModel> arrayList) {
