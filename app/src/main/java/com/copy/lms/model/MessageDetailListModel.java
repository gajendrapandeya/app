...
public class MessageDetailListModel extends BaseObservable {
    ...
    public ArrayList<MessageDetailModel> getArrayList() {
        return arrayList;
    }

    public void setArrayList(ArrayList<MessageDetailModel> arrayList) {
