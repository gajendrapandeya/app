...
public class SponserListModel extends BaseObservable {
    ...
    public ArrayList<SponserModel> getArrayList() {
        return arrayList;
    }

    public void setArrayList(ArrayList<SponserModel> arrayList) {
